...
<div class="main">
	...
	<div class="content" style="width: 75%; margin: 0 0 0 25%">
		...
		<p><strong>Contractor Information</strong>  - The contractor provides to the Property Manager a task and site-specific risk assessment and method statement prior to the works commencing. This will outline specific risks associated with the work, how these could impact on residents/others and how these will be managed for the duration of the work.
