...
<div class="main">
	...
	<div class="content" style="width: 75%; margin: 0 0 0 25%">
		...
		<h2>Data Protection Act 1998<br /></h2>
		<p>In line with the requirements of The Data Protection Act 1998 we expect you to maintain policies and procedures to comply with the 8 Principles. All responsibility for compliance lies with you in respect of any data you find yourself in possession of in the course of your contracted work for <?=$name;?>.<br /></p>
		...
		<p><strong>Maintenance Visits &amp; Reports</strong></p>
		<p>The first maintenance visit will take place within 30 days from the date of this purchase order and all associated certification or maintenance reports, will be emailed to <a href="mailto:contractors@<?=$domain;?>">contractors@<?=$domain;?></a> within 14 days of the site visit.</p>
		...
		<p>A copy must be forwarded to <a href="mailto:contractors@<?=$domain;?>">contractors@<?=$domain;?></a> upon completion.</p>
		...
		<ol>
			<li>You will provide the services with reasonable care and skill, in a correct, safe and professional manner and use all necessary and appropriate equipment and materials required, to enable compliance with health and safety legislation.
				<ol>
					...
					<li>You will protect the Management Company from any future loss, damage, or liability (whether criminal or civil) suffered resulting from a breach of this agreement by you. Including any act, neglect or default of your employees or agents, and any breaches in respect of any matter arising from the provision of the services resulting in any successful claim by any third party.</li>
					<li>Provide documentation to <?=$name;?> any accident book entries that occur on site.</li>
				</ol>
			</li>
			...
			<li>All invoices should be emailed to <a href="mailto:postroom@<?=$domain;?>">postroom@<?=$domain;?></a>, or sent to our Hoddesdon address.  Please address your invoices as Name of Management Company or Freeholder, c/o <?=$name;?>., RMG House, Essex Road, Hoddesdon, Hertfordshire, EN11 0DR.  Also on your invoice our Job Number must be quoted, a unique invoice number used, the site property address quoted in full and duplicate invoices must not be presented.  Invoices not containing these details will be returned.
				<ol>
					<li>Please note our terms of payment are 30 days upon receipt of your invoice; subject to funding of the Management Company.</li>
				</ol>
			</li>
			<li>The Management Company can terminate the contract by serving on you a notice in writing, stating that your services are to cease 28 days from the date of the notice.</li>
			<li>The Management Company may terminate your services without notice in the event of:
				<ul>
			...
			<li>A Method Statement for works may sometimes be required. When requested please forward a copy to <a href="mailto:contractors@<?=$domain;?>">contractors@<?=$domain;?></a>.
				<ol>
		...
		<ul class="download-list">
			...
			<!--<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Home Safety Fire Guide</p>
				</div>
				<a target="_blank" href="/pdfs/Fire.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Confined spaces</p>
					<p class="desc">A brief guide to working safely</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg258.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Protecting the public</p>
					<p class="desc">Your next move</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg151.pdf" class="download">
				</a>
			</li>
			...
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Controlling fire and explosion</p>
					<p class="desc">A brief guide to the Dangerous Substances and Explosive Atmospheres<br /> Regulations</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg370.pdf" class="download">
				</a>
			</li>
			...
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Electricity at work</p>
					<p class="desc">Safe working practices</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg85.pdf" class="download">
				</a>
			</li>
			...
			<li>
				...
				<div class="info">
					...
					<p class="desc">A brief guide to controlling risks in the workplace</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg163.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Fragile roofs</p>
					<p class="desc">Safe working practices</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/geis5.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Noise</p>
					<p class="desc">Don't lose your hearing!</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg363.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Maintaining portable electrical equipment</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg107.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Avoiding danger from underground services</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg47.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">The safe use of compressed gases in</p>
					<p class="desc">Welding, flame cutting and allied processes</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg139.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Safety in window cleaning</p>
					<p class="desc">Using suspended and powered access equipment</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/misc611.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Safety in window cleaning</p>
					<p class="desc">Using portable ladders</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/misc613.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Working at height</p>
					<p class="desc">A brief guide</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg401.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Working on roofs</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg284.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Safe use of ladders and stepladders</p>
					<p class="desc">A brief guide</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/indg455.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Working with asbestos in buildings</p>
				</div>
				<a target="_blank" href="/pdfs/indg289.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Asbestos</p>
					<p class="desc">The hidden killer</p>
				</div>
				<a target="_blank" href="/pdfs/AsbestosHiddenKiller.pdf" class="download">
				</a>
			</li>
			<li>
				<div class="pdf"></div>
				<div class="info">
					<p class="title">Caring for cleaners</p>
					<p class="desc">Guidance and case studies on how to prevent musculoskeletal disorders</p>
				</div>
				<a target="_blank" href="http://www.hse.gov.uk/pubns/priced/hsg234.pdf" class="download">
				</a>
			</li>-->
		</ul>
	</div>
